export default function Hero() {
  return (
    <div className="py-20 text-center bg-gradient-to-b from-white to-gray-50">
      ...
      I’m Steve Jobs, and I’ve spent my career at Apple crafting experiences that seamlessly blend technology and design. 
      As a UI/UX designer, I focus on creating intuitive, user-centered designs that make technology feel natural and empowering.
       ...
       At Apple, we design with the user in mind, and I’m committed to continuing that legacy through innovative, thoughtful design.
      </p>
